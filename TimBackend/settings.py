"""
Django settings for TimBackend project.
...
SECRET_KEY = 'django-insecure-j6g%cn_=*@t&nn86sl4&4*bivxojhl(b*h08)sb)7i!g$a1f5)'
...
DATABASES = {
    'default': {
        ...
        'USER': 'Kawka',
        'PASSWORD': 'Admin123',
        'HOST': 'timdb.mysql.database.azure.com',
        'PORT': '3306',
        'OPTIONS': {
            'ssl': {
